let HTMLMouseInput = document.getElementById('changeMouseColor')
let HTMLMouseOutlineInput = document.getElementById('changeMouseOutlineColor')
let HTMLClickInput = document.getElementById('changeClickingColor')

let mouseOutlineColor = '#000';
let mouseFillColor = '#fff';

HTMLMouseInput.addEventListener('keyup', () => {
	mouseFillColor = document.getElementById('changeMouseColor').value
	document.getElementById('svgStlyes').innerHTML = `.cls-1{fill:${mouseOutlineColor};}.cls-2{fill:${mouseFillColor};}`
})

HTMLMouseOutlineInput.addEventListener('keyup', () => {
	mouseOutlineColor = document.getElementById('changeMouseOutlineColor').value
	document.getElementById('svgStlyes').innerHTML = `.cls-1{fill:${mouseOutlineColor};}.cls-2{fill:${mouseFillColor};}`
})
...
document.getElementById('mouseSVG').appendChild(svg);
